"""
Django settings for case_silant project.
...
SECRET_KEY = 'django-insecure-+qytd*8yyen3!5x5ua&%=2)&vodu^8e#*#0-ele7hsaf=5_!+*'
...
WSGI_APPLICATION = 'case_silant.wsgi.application'
